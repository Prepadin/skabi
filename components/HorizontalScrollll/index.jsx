    ...
    return (
        <div className="bg-neutral-800">
            <div className="flex h-48 items-center justify-center">
                <span className="font-semibold uppercase  text-9xl font-serif text-slate-300">
                    <h1>  history </h1>
                </span>
            </div>
            ...
            <div className="sticky top-0 flex h-screen items-center overflow-hidden ">
                <motion.div style={{ x }} className="flex">
                    <motion.div
                        ...
                        // style={{ scale }}
                        className="group relative h-[60vh]  w-[1050px] overflow-hidden  mx-32 mt-64  bg-neutral-900">
                    ...
                    <motion.div
                        ...
                        // style={{ scale }}
                        className="group relative h-[80vh]  w-[1350px] overflow-hidden  mx-32 mt-64  bg-neutral-900">
                        <h2 className="text-5xl font-serif text-slate-300">During the First World War it was a stronghold of the Austro-Hungarian Army. The hill was fought over in the Eleventh Battle of the Isonzo. During the battle, the top of Škabrijel Hill was lost and recaptured nine times by the Austro-Hungarians. One officer described the fighting, stating: Around 6 on clock in the morning, the Italians attacked for the first time, and then it went all day. But we always repulsed them with hand grenades, machine guns tried to take the trenches. I was on the left wing with six other men, strong and fearless. They went forward when they attacked, even the second time they persisted even though they were wounded and one dead. We held out and repulsed them with hand grenades. Due to artillery bombardment by the Italian Army during the First World War, the hill—now densely wooded—was left almost entirely bare. </h2>
                    </motion.div>
                </motion.div>
