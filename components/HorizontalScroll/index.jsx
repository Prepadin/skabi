            ...
            <div className="sticky top-0 flex h-screen items-center overflow-hidden">
                <motion.div style={{ x }} className="flex">
                    <motion.div
                        ...
                        style={{ scale }}
                        className="sticky group relative h-screen w-[1550px] overflow-hidden bg-neutral-200">
                        <div className="uppercase text-xl">Eat my balls</div>
                        <Image src={ska} />

                    </motion.div>
                    <motion.div style={{ scale }} className="group relative h-screen w-[1550px] overflow-hidden bg-neutral-200">
                        <div>go go  now</div>
                        <Image src={tour} />
